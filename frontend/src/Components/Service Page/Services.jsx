...
function Services() {
  ...
  const handleSubmit = () => {
    ...
    if (Number(duration) > 12) {
      ...
      toast({
        ...
        description: "Duration cannot exceed 12 hours per day",
  ...
  const handleDurationChange = (valueString) => {
    ...
    if (value > 12) {
      ...
      setHours("12"); // Set to maximum allowed
        ...
        <div className="services-container">
          ...
          <section className="section" id="s1">
            ...
            <article>
              ...
              <button onClick={handleBookingClick} className="boarding">Book Pets Boarding</button>
          ...
          <section className="section" id="s3">
            ...
            <article>
              ...
              <button className="training" onClick={handleBookingClick}>Book Training Session</button>
